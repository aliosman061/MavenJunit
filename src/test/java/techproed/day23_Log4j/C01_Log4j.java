...
logger.error("Error logger"); logger.fatal ("Fatal logger");
    ...
    public void log4j() {
        ...
        koydugumuz log4j2.xml file da belirttigimiz .log uzantili dosyada yine tarih saat olarak kayit altina
        almis olacagiz.
        ...
        adresinden (ayni version numaralarina sahip ) alip pom.xml dosyamiza koymaliyiz.
            src>main>resources icine koydugumuz log4j2.xml dosyasindaki kodlara pdf deki adresten ulasabilirsiniz
