...
public class C01_Cookies extends TestBase {
    ...
    public void test01() {
        ...
        /*
        Cookilleri listelemek istersek driver.manage().getCookies() methoduyla bir set yada
        arrayliste atarak listeleyebiliriz.
        */
        ...
        for (Cookie w : cookieSet) {
            ...
            System.out.println(sayac+".cookie name :"+w.getName());//sadece cookilern isimlerini alırız.
            System.out.println(sayac+".cookie value :"+w.getValue());//sadece cookilerin value larını alrız.
            sayac++;
        }


        //3-Sayfadaki cookies sayisinin 5’den buyuk oldugunu test edin
        System.out.println("Cookilerin sayısıs : " +cookieSet.size());
